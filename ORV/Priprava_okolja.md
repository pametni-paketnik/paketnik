...
Korak 4: Namesti knjižnice, ki jih potrebuješ za učenje modela (kot sva rekla v prejšnjem odgovoru):
Bash
...
To bo v tvojem brskalniku odprlo okno, kjer boš videl datoteke v tvoji mapi projekta. Tam klikneš New -> Notebook (Python 3) in pripravljen si na uvoz slik in učenje modela!
